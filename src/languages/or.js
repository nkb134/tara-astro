export default {
  ...
  ask_time: `Ok... janma samaya jananti ki? Na janile kichchhi nahi, samaya bina bi bahut kichchhi kahi paribi`,
  ask_place: `Achha. Kouthi janma hoisathila? City kahanti`,
  ask_place_after_unknown_time: `Kichchhi nahi, samaya na janile bi kundli ru bahut bujhi paribi. Kouthi janma hoisathila?`,
  ...
  chart_failed_2: `Ethi bi samasyaa hauchi... thoda bele pare aau thare try karanti 🙏`,

  frustration_apology: `Sorry, mora bhul — aau thare dekhuchi`,

  disambiguate_few: `{city} naamre bahut jagaa achhi — {options} kounata?`,
  disambiguate_many: `E naamre bahut jagaa achhi... state bi kahanti?`,

  chart_overview: `{name}, kundli taiyaar 🌟\n\n☀️ Surya rashi: {sunSign}\n🌙 Chandra rashi: {moonSign}\n⬆️ Lagna: {ascendant}\n⭐ Nakshatra: {nakshatra}\n🔄 Dasha: {dasha}\n\n{notable}\n\nKie janiba chahuchanti — career, baha, na aau kichchhi?`,

  notable_exalted: `Aapanka {planet} {sign} re uchcha — bahut bhala abasthaa`,
  notable_vargottama: `Aapanka {planet} Vargottam — rashi o navamsha duiti re samana. Bahut strong`,
  notable_strong: `Aapanka {planet} {power}% shaktire achhi — bhala abasthaa`,
  notable_default: `Kundli re interesting kichchhi achhi — detail re dekhiba`,
